...
curl -XPOST "http://$JENKINS_URL/createItem?name=TheProject" -u  $2:$3 --data-binary @config_resources/multipipeline.xml -v --cookie "$COOKIEJAR" -H $CRUMB -H "Content-Type:text/xml"